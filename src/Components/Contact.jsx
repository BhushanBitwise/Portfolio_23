  ...
  const social = [
    {
      name: "LinkedIn",
      icon: <FaLinkedinIn />,
      link:"https://www.linkedin.com/in/bhushan-gadekar-5b87032a5?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    },
    {
      name: "Instagram",
      icon: <FaInstagram />,
      link:"https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=ivhexv2",
    },
    {
      name: "Github",
      icon: <FaGithub />,
      link: "https://github.com/BhushanBitwise",
    },
  ];
  useEffect(() => {}, [need]);
  return (
      ...
      <div className="cotactcontent flex flex-col-reverse lg:flex-row px-6 md:px-12 h-full w-full absolute z-[0]">
        <div className="leftpart leading-[1.22] h-[30%] lg:h-full text-white text-3xl md:text-6xl lg:text-5xl flex flex-col pb-8 lg:pb-20 justify-end md:w-full lg:w-[50%] ">
          <h1 className="font-[helvetica]">
            ...
            >
              Thanks for <span className="bg-gradient-to-r from-orange-800 to-white bg-clip-text text-transparent">stopping</span>
            </motion.span>
          </h1>
          <h1 className="font-[helvetica]">
            <motion.span
          ...
          <h1 className="font-[helvetica]">
            <motion.span
              ...
              className="inline-block font-[helvetica] "
            >
              crafted with <span className="bg-gradient-to-r from-pink-800 to-white bg-clip-text text-transparent">love</span>
            </motion.span>
          </h1>
          <h1>
            {" "}
            ...
            >
             <span className="bg-gradient-to-r from-green-800 to-white bg-clip-text text-transparent">by me! 🫶</span>
            </motion.span>{" "}
          </h1>
        </div>
        <div className="rightpart h-[70%] lg:h-full flex flex-col pb-8 lg:pb-20 justify-end w-full lg:w-[50%] ">
          ...
          <h2 className="text-white mt-4 md:mt-6 md:text-4xl lg:mt-8 text-2xl lg:text-3xl ">
            <span className="bg-gradient-to-r from-green-300 to-white bg-clip-text text-transparent">Feel free to reach out for collabs or opportunities!</span>
          </h2>
          <a
            href="mailto:bhushangadekar752@gmail.com"
