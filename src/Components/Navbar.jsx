...
// import resume from "../assets/SwarajSingh Resume - NIT Goa (1).pdf";
import resume from "../assets/Bhushan752resume.pdf";
function Navbar() {
  const mouseenter = () => {
    ...
    <div className="w-full backdrop-blur-sm fixed flex items-center justify-between px-6 md:px-12 z-[200] top-0 left-0 h-24 ">
      <div className="leftnav">
        ...
        >
          ...
          <h1 className="h-full flex items-center  w-full">
            <span className="text-white text-[1.9vw]">Portfolio'23</span>
          </h1>
        </div>
      </div>
